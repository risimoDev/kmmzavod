...
const PRESETS: { label: string; icon: string; hint: string; patch: PresetPatch }[] = [
  ...
  { label: "1-Word Flash", icon: "⚡", hint: "По 1 слову на экране, удержание 100%, 15с",
    patch: { name: "Flash Шортс", mode: "smart_montage", geometry: "highlights", aspect: "9:16", subtitleStyle: "single_word", audioMode: "keep", targetClipCount: 3, targetClipSeconds: 15 } },
  ...
  { label: "Динамичный Микс", icon: "🎛️", hint: "Нарезка из всех источников в 1 цельный ролик, 30с",

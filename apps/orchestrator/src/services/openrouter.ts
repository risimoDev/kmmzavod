...
/** Sanitize script text for natural TTS synthesis (Fish Audio with emotion tags). */
export function sanitizeForVoiceover(text: string): string {
  return text
    // Remove markdown symbols (asterisks, hashtags, underscores, brackets except emotion tags)
